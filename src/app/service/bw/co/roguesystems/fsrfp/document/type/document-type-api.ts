...
export class DocumentTypeApi {
  ...
  public getAllPaged(pageNumber: number | any, pageSize: number | any): Observable<Page<DocumentTypeDTO>[] | any[]> {
    return this.http.get<Page<DocumentTypeDTO>[] | any[]>(
  ...
  public pagedSearch(
    ...
    pageSize: number | any,
  ): Observable<Page<DocumentTypeDTO> | any> {
    return this.http.get<Page<DocumentTypeDTO> | any>(
      `${this.path}/search/paged?pageNumber=${pageNumber}&pageSize=${pageSize}&criteria=${criteria}`,
    );
  }
