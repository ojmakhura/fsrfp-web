import { takeUntilDestroyed } from './chunk-VHXQKPRR.js';
import { DomSanitizer } from './chunk-DTDSM6HR.js';
import './chunk-O5IRBPO4.js';
import './chunk-NKM73PB6.js';
import { NG_VALIDATORS, NG_VALUE_ACCESSOR } from './chunk-WXKJKQEY.js';
import './chunk-LJRMVWU3.js';
import { isPlatformServer } from './chunk-SOO5Y25R.js';
import {
  ChangeDetectorRef,
  Component,
  DestroyRef,
...
import { defer, forkJoin, fromEvent, isObservable } from './chunk-WPM5VTLQ.js';
import { Observable, Subscription, debounceTime, map, mergeMap, of, shareReplay, tap } from './chunk-4S3KYZTJ.js';
import { __async } from './chunk-4MWRP73S.js';
    ...
    this.quill$ = defer(() =>
      __async(this, null, function* () {
        if (!this.Quill) {
          ...
          const { Quill } = yield import('./ngx-quill-quill-CUw8Q_m0-WDPCKBR6.js');
...
var QuillEditorBase = class _QuillEditorBase {
  constructor() {
    ...
    this.selectionChangeHandler = (range, oldRange, source) => {
      ...
      const shouldTriggerOnModelTouched =
        !range && !!this.onModelTouched && (source === 'user' || (trackChanges && trackChanges === 'all'));
      if (
    ...
    this.textChangeHandler = (delta, oldDelta, source) => {
      ...
      const shouldTriggerOnModelChange =
        (source === 'user' || (trackChanges && trackChanges === 'all')) && !!this.onModelChange;
  ...
  ngAfterViewInit() {
    ...
    this.quillSubscription = this.service
      .getQuill()
      .pipe(mergeMap((Quill) => this.service.beforeRender(Quill, this.customModules(), this.beforeRender())))
      .subscribe((Quill) => {
        ...
        this.zone.runOutsideAngular(() => {
          ...
          if (this.onNativeBlur.observed) {
            fromEvent(this.quillEditor.scroll.domNode, 'blur')
            ...
            if (toolbar.container) {
              fromEvent(toolbar.container, 'mousedown')
                .pipe(takeUntilDestroyed(this.destroyRef))
                .subscribe((e) => e.preventDefault());
            }
          }
          if (this.onNativeFocus.observed) {
            fromEvent(this.quillEditor.scroll.domNode, 'focus')
              .pipe(takeUntilDestroyed(this.destroyRef))
              .subscribe(() =>
  ...
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
      ...
      return function QuillEditorComponent_Factory(__ngFactoryType__) {
        return (
          ɵQuillEditorComponent_BaseFactory ||
          (ɵQuillEditorComponent_BaseFactory = ɵɵgetInheritedFactory(_QuillEditorComponent))
        )(__ngFactoryType__ || _QuillEditorComponent);
      };
    })();
  }
  static {
...
var QuillViewComponent = class _QuillViewComponent {
  ...
  ngAfterViewInit() {
    ...
    const quillSubscription = this.service
      .getQuill()
      .pipe(mergeMap((Quill) => this.service.beforeRender(Quill, this.customModules(), this.beforeRender())))
      .subscribe((Quill) => {
        const modules = Object.assign({}, this.modules() || this.service.config.modules);
