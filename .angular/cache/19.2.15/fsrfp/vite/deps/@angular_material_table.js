import { _DisposeViewRepeaterStrategy } from './chunk-XY3YD4BN.js';
import './chunk-JXBCBRYI.js';
import { ScrollingModule, ViewportRuler } from './chunk-2N4M46HE.js';
import {
  DataSource,
...
import { _isNumberValue } from './chunk-GWH5ZIVQ.js';
...
import { BehaviorSubject, Subject, combineLatest, map, of, takeUntil } from './chunk-4S3KYZTJ.js';
...
var CdkTable = class _CdkTable {
  ...
  renderRows() {
    ...
    this._viewRepeater.applyChanges(
      changes,
      viewContainer,
      (record, _adjustedPreviousIndex, currentIndex) => this._getEmbeddedViewArgs(record.item, currentIndex),
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function CdkTable_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵprojection(0);
        ɵɵprojection(1, 1);
        ɵɵtemplate(2, CdkTable_Conditional_2_Template, 1, 0)(3, CdkTable_Conditional_3_Template, 7, 0)(
          4,
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatTable_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵprojection(0);
        ɵɵprojection(1, 1);
        ɵɵtemplate(2, MatTable_Conditional_2_Template, 1, 0)(3, MatTable_Conditional_3_Template, 7, 0)(
          4,
...
var MatCellDef = class _MatCellDef extends CdkCellDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatCellDef_Factory(__ngFactoryType__) {
      return (ɵMatCellDef_BaseFactory || (ɵMatCellDef_BaseFactory = ɵɵgetInheritedFactory(_MatCellDef)))(
...
var MatHeaderCellDef = class _MatHeaderCellDef extends CdkHeaderCellDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatHeaderCellDef_Factory(__ngFactoryType__) {
      return (
        ɵMatHeaderCellDef_BaseFactory || (ɵMatHeaderCellDef_BaseFactory = ɵɵgetInheritedFactory(_MatHeaderCellDef))
...
var MatFooterCellDef = class _MatFooterCellDef extends CdkFooterCellDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatFooterCellDef_Factory(__ngFactoryType__) {
      return (
        ɵMatFooterCellDef_BaseFactory || (ɵMatFooterCellDef_BaseFactory = ɵɵgetInheritedFactory(_MatFooterCellDef))
...
var MatColumnDef = class _MatColumnDef extends CdkColumnDef {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatColumnDef_Factory(__ngFactoryType__) {
      return (ɵMatColumnDef_BaseFactory || (ɵMatColumnDef_BaseFactory = ɵɵgetInheritedFactory(_MatColumnDef)))(
...
var MatHeaderCell = class _MatHeaderCell extends CdkHeaderCell {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatHeaderCell_Factory(__ngFactoryType__) {
      return (ɵMatHeaderCell_BaseFactory || (ɵMatHeaderCell_BaseFactory = ɵɵgetInheritedFactory(_MatHeaderCell)))(
...
var MatFooterCell = class _MatFooterCell extends CdkFooterCell {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatFooterCell_Factory(__ngFactoryType__) {
      return (ɵMatFooterCell_BaseFactory || (ɵMatFooterCell_BaseFactory = ɵɵgetInheritedFactory(_MatFooterCell)))(
...
var MatHeaderRowDef = class _MatHeaderRowDef extends CdkHeaderRowDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatHeaderRowDef_Factory(__ngFactoryType__) {
      return (ɵMatHeaderRowDef_BaseFactory || (ɵMatHeaderRowDef_BaseFactory = ɵɵgetInheritedFactory(_MatHeaderRowDef)))(
...
var MatFooterRowDef = class _MatFooterRowDef extends CdkFooterRowDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatFooterRowDef_Factory(__ngFactoryType__) {
      return (ɵMatFooterRowDef_BaseFactory || (ɵMatFooterRowDef_BaseFactory = ɵɵgetInheritedFactory(_MatFooterRowDef)))(
...
var MatRowDef = class _MatRowDef extends CdkRowDef {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatRowDef_Factory(__ngFactoryType__) {
      return (ɵMatRowDef_BaseFactory || (ɵMatRowDef_BaseFactory = ɵɵgetInheritedFactory(_MatRowDef)))(
...
var MatHeaderRow = class _MatHeaderRow extends CdkHeaderRow {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatHeaderRow_Factory(__ngFactoryType__) {
      return (ɵMatHeaderRow_BaseFactory || (ɵMatHeaderRow_BaseFactory = ɵɵgetInheritedFactory(_MatHeaderRow)))(
...
var MatFooterRow = class _MatFooterRow extends CdkFooterRow {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatFooterRow_Factory(__ngFactoryType__) {
      return (ɵMatFooterRow_BaseFactory || (ɵMatFooterRow_BaseFactory = ɵɵgetInheritedFactory(_MatFooterRow)))(
...
var MatNoDataRow = class _MatNoDataRow extends CdkNoDataRow {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatNoDataRow_Factory(__ngFactoryType__) {
      return (ɵMatNoDataRow_BaseFactory || (ɵMatNoDataRow_BaseFactory = ɵɵgetInheritedFactory(_MatNoDataRow)))(
        __ngFactoryType__ || _MatNoDataRow,
      );
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var MatTextColumn = class _MatTextColumn extends CdkTextColumn {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatTextColumn_Factory(__ngFactoryType__) {
      return (ɵMatTextColumn_BaseFactory || (ɵMatTextColumn_BaseFactory = ɵɵgetInheritedFactory(_MatTextColumn)))(
