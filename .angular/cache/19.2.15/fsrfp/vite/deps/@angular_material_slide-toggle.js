import { _MatInternalFormField } from './chunk-577TTFH2.js';
import { CheckboxRequiredValidator, NG_VALIDATORS, NG_VALUE_ACCESSOR } from './chunk-WXKJKQEY.js';
...
import { FocusMonitor, MatCommonModule, _IdGenerator } from './chunk-PQSRNTO7.js';
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatSlideToggle_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵclassProp('mat-mdc-slide-toggle-focused', ctx._focused)('mat-mdc-slide-toggle-checked', ctx.checked)(
    ...
    consts: [
      ...
      ['role', 'switch', 'type', 'button', 1, 'mdc-switch', 3, 'click', 'tabIndex', 'disabled'],
      [1, 'mdc-switch__track'],
    ...
    template: function MatSlideToggle_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵadvance();
        ɵɵclassProp('mdc-switch--selected', ctx.checked)('mdc-switch--unselected', !ctx.checked)(
          'mdc-switch--checked',
          ctx.checked,
        )('mdc-switch--disabled', ctx.disabled)('mat-mdc-slide-toggle-disabled-interactive', ctx.disabledInteractive);
        ɵɵproperty('tabIndex', ctx.disabled && !ctx.disabledInteractive ? -1 : ctx.tabIndex)(
          'disabled',
          ctx.disabled && !ctx.disabledInteractive,
        );
        ɵɵattribute('id', ctx.buttonId)('name', ctx.name)('aria-label', ctx.ariaLabel)(
          'aria-labelledby',
          ctx._getAriaLabelledBy(),
        )('aria-describedby', ctx.ariaDescribedby)('aria-required', ctx.required || null)('aria-checked', ctx.checked)(
          'aria-disabled',
          ctx.disabled && ctx.disabledInteractive ? 'true' : null,
        );
        ɵɵadvance(8);
        ɵɵproperty('matRippleTrigger', switch_r2)('matRippleDisabled', ctx.disableRipple || ctx.disabled)(
          'matRippleCentered',
          true,
        );
        ɵɵadvance();
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatSlideToggleRequiredValidator_Factory(__ngFactoryType__) {
      return (
        ...
        (ɵMatSlideToggleRequiredValidator_BaseFactory = ɵɵgetInheritedFactory(_MatSlideToggleRequiredValidator))
      )(__ngFactoryType__ || _MatSlideToggleRequiredValidator);
    };
  })();
