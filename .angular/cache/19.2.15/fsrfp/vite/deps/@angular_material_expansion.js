import { UniqueSelectionDispatcher } from './chunk-XY3YD4BN.js';
...
import { EMPTY, Subject, Subscription, filter, startWith, take } from './chunk-4S3KYZTJ.js';
...
var MatExpansionPanelHeader = class _MatExpansionPanelHeader {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatExpansionPanelHeader_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵattribute('id', ctx.panel._headerId)('tabindex', ctx.disabled ? -1 : ctx.tabIndex)(
          'aria-controls',
          ctx._getPanelId(),
        )('aria-expanded', ctx._isExpanded())('aria-disabled', ctx.panel.disabled);
        ...
        )('mat-expansion-toggle-indicator-before', ctx._getTogglePosition() === 'before');
      }
    },
    inputs: {
...
var MatAccordion = class _MatAccordion extends CdkAccordion {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatAccordion_Factory(__ngFactoryType__) {
      return (ɵMatAccordion_BaseFactory || (ɵMatAccordion_BaseFactory = ɵɵgetInheritedFactory(_MatAccordion)))(
        __ngFactoryType__ || _MatAccordion,
      );
    };
  })();
  static ɵdir = ɵɵdefineDirective({
