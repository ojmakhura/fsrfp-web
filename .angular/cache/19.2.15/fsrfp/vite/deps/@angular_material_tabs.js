import { SharedResizeObserver } from './chunk-IXEVHMJP.js';
import './chunk-OIBNGD5S.js';
import { CdkPortal, CdkPortalOutlet, TemplatePortal } from './chunk-3HDMKNHX.js';
import { MAT_RIPPLE_GLOBAL_OPTIONS, MatRipple } from './chunk-6K32XFRM.js';
import { _StructuralStylesLoader } from './chunk-IBJRQVUD.js';
import './chunk-BS4LDW6B.js';
import './chunk-42FJBLFI.js';
import './chunk-JXBCBRYI.js';
import { CdkScrollable, ViewportRuler } from './chunk-2N4M46HE.js';
...
function MatTabGroup_For_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵattribute('tabIndex', ctx_r5._getTabIndex($index_r5))('aria-posinset', $index_r5 + 1)(
      'aria-setsize',
      ctx_r5._tabs.length,
    )('aria-controls', ctx_r5._getTabContentId($index_r5))('aria-selected', ctx_r5.selectedIndex === $index_r5)(
      'aria-label',
      tab_r4.ariaLabel || null,
    )('aria-labelledby', !tab_r4.ariaLabel && tab_r4.ariaLabelledby ? tab_r4.ariaLabelledby : null);
    ɵɵadvance(3);
...
function MatTabGroup_For_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty('id', ctx_r5._getTabContentId($index_r11))('content', tab_r10.content)('position', tab_r10.position)(
      'animationDuration',
      ctx_r5.animationDuration,
    )('preserveContent', ctx_r5.preserveContent);
    ɵɵattribute(
      'tabindex',
      ctx_r5.contentTabIndex != null && ctx_r5.selectedIndex === $index_r11 ? ctx_r5.contentTabIndex : null,
...
var MatTabLabel = class _MatTabLabel extends CdkPortal {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatTabLabel_Factory(__ngFactoryType__) {
      return (ɵMatTabLabel_BaseFactory || (ɵMatTabLabel_BaseFactory = ɵɵgetInheritedFactory(_MatTabLabel)))(
...
var MatTabHeader = class _MatTabHeader extends MatPaginatedTabHeader {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatTabHeader_Factory(__ngFactoryType__) {
      return (ɵMatTabHeader_BaseFactory || (ɵMatTabHeader_BaseFactory = ɵɵgetInheritedFactory(_MatTabHeader)))(
    ...
    template: function MatTabBody_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵclassProp('mat-tab-body-content-left', ctx._position === 'left')(
          ...
          ctx._position === 'right',
        )('mat-tab-body-content-can-animate', ctx._position === 'center' || ctx._previousPosition === 'center');
      }
    },
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatTabGroup_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        )('aria-label', ctx.ariaLabel)('aria-labelledby', ctx.ariaLabelledby);
        ɵɵadvance(2);
    ...
    hostBindings: function MatTabLink_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵattribute('aria-controls', ctx._getAriaControls())('aria-current', ctx._getAriaCurrent())(
          'aria-disabled',
          ctx.disabled,
        )('aria-selected', ctx._getAriaSelected())('id', ctx.id)('tabIndex', ctx._tabIndex())('role', ctx._getRole());
