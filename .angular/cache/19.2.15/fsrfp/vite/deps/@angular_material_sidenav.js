...
import { CdkScrollable, CdkScrollableModule, ScrollDispatcher, ViewportRuler } from './chunk-2N4M46HE.js';
...
import { fromEvent, merge } from './chunk-WPM5VTLQ.js';
import { Subject, debounceTime, filter, map, mapTo, startWith, take, takeUntil } from './chunk-4S3KYZTJ.js';
...
var MatDrawerContent = class _MatDrawerContent extends CdkScrollable {
  ...
  _shouldBeHidden() {
    ...
    return (
      (start != null && start.mode !== 'over' && start.opened) || (end != null && end.mode !== 'over' && end.opened)
    );
  }
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatDrawer_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵclassProp('mat-drawer-end', ctx.position === 'end')('mat-drawer-over', ctx.mode === 'over')(
          'mat-drawer-push',
          ctx.mode === 'push',
        )('mat-drawer-side', ctx.mode === 'side');
      }
    },
    inputs: {
      position: 'position',
...
var MatSidenavContent = class _MatSidenavContent extends MatDrawerContent {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatSidenavContent_Factory(__ngFactoryType__) {
      return (
        ɵMatSidenavContent_BaseFactory || (ɵMatSidenavContent_BaseFactory = ɵɵgetInheritedFactory(_MatSidenavContent))
...
var MatSidenav = class _MatSidenav extends MatDrawer {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatSidenav_Factory(__ngFactoryType__) {
      return (ɵMatSidenav_BaseFactory || (ɵMatSidenav_BaseFactory = ɵɵgetInheritedFactory(_MatSidenav)))(
    ...
    hostBindings: function MatSidenav_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵclassProp('mat-drawer-end', ctx.position === 'end')('mat-drawer-over', ctx.mode === 'over')(
          'mat-drawer-push',
          ctx.mode === 'push',
        )('mat-drawer-side', ctx.mode === 'side')('mat-sidenav-fixed', ctx.fixedInViewport);
      }
    },
    inputs: {
